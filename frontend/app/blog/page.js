  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-20">
      <div className="text-center">
        ...
        <h1 className="mt-5 font-display text-3xl font-bold text-white">Stories, ideas &amp; updates</h1>
      ...
      <div className="mt-16">
        ...
        {!loading && filtered.length === 0 && (
          <p className="py-16 text-center text-slate-500">
            {query ? "No posts match your search." : "No posts yet — be the first to write one!"}
          </p>
        )}
