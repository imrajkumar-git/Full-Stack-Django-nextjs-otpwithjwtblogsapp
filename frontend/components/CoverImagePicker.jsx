          ...
          <div className="absolute inset-x-0 bottom-0 flex items-center justify-between gap-3 bg-gradient-to-t from-black/85 to-transparent px-4 py-3">
            ...
            <span className="flex shrink-0 gap-2">
              <button
                ...
                disabled={disabled}
                className="rounded-full border border-white/20 bg-black/50 px-3 py-1 text-xs font-medium text-slate-100 transition hover:border-emerald-400/60"
              >
                Replace
              </button>
              <button
                ...
                onClick={clear}
                disabled={disabled}
                className="rounded-full border border-red-400/30 bg-red-400/10 px-3 py-1 text-xs font-medium text-red-300 transition hover:border-red-400/60"
              >
                Remove
              </button>
            </span>
